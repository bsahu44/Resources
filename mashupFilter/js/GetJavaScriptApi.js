...
spotfire.webPlayer.Filtering.FilteringScheme.prototype.getFilterColumn = function(dataTableName, filterColumnName, includedFilterSettings, callback)
{
    ...
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','filteringSchemeProxy','getFilterColumn'], arguments);
};
...
spotfire.webPlayer.Filtering.FilteringScheme.prototype.getFilterColumns = function(dataTableName, includedFilterSettings, callback)
{
    ...
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','filteringSchemeProxy','getFilterColumns'], arguments);
};
...
spotfire.webPlayer.Filtering.FilteringScheme.prototype.getDefaultFilterColumns = function(includedFilterSettings, callback)
{
    ...
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','filteringSchemeProxy','getDefaultFilterColumns'], arguments);
};
...
spotfire.webPlayer.Data.prototype.onRangeChanged = function(filteringSchemeName, dataTableName, dataColumnName, callback) 
{
    ...
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataProxy','onRangeChanged'], arguments);
};
...
spotfire.webPlayer.Data.prototype.getDataTable = function(dataTableName, callback)
{
    ...
    /// <param name="callback" type="function">A callback function with the following signature: function(dataTable) {}. The first parameter in the signature is an instance of the spotfire.webPlayer.Data.DataTable class.</param>
     ...
     this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataProxy','getDataTable'], arguments);
};
...
spotfire.webPlayer.Data.prototype.getDataTables = function(callback)
{
    ...
    /// <param name="callback" type="function">A callback function with the following signature: function(dataTables) {}. The first parameter in the signature is an array of spotfire.webPlayer.Data.DataTable instances.</param>
     ...
     this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataProxy','getDataTables'], arguments);
};
...
spotfire.webPlayer.Data.prototype.getActiveDataTable = function(callback)
{
    ...
    /// <param name="callback" type="function">A callback function with the following signature: function(dataTable) {}. The first parameter in the signature is an instance of the spotfire.webPlayer.Data.DataTable class.</param>
     ...
     this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataProxy','getActiveDataTable'], arguments);
};
...
spotfire.webPlayer.Data.DataTable.prototype.getDataColumn = function(dataColumnName, callback)
{
    ...
    arguments[2] = callback;
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataTableProxy','getDataColumn'], arguments);
};
...
{  
    ...
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataTableProxy','getDataColumns'], arguments);
};
...
spotfire.webPlayer.Data.DataTable.prototype.searchDataColumns = function(searchExpression, callback)
{
    ...
    arguments[2] = callback;
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataTableProxy','searchDataColumns'], arguments);
};
...
spotfire.webPlayer.Data.DataTable.prototype.getDataTableProperties = function(callback)
{
    ...
    arguments[0] = this.dataTableName;
    arguments[1] = callback;
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataTableProxy','getDataTableProperties'], arguments);
};
...
spotfire.webPlayer.Data.DataTable.prototype.getDataTableProperty = function(propertyName, callback)
{
    ...
    arguments[2] = callback;
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataTableProxy','getDataTableProperty'], arguments);
};
...
spotfire.webPlayer.Data.DataTable.prototype.setDataTableProperty = function(propertyName, propertyValue)
{
    ...
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataTableProxy','setDataTableProperty'], arguments);
};
...
spotfire.webPlayer.Data.DataTable.prototype.onDataTablePropertyChanged = function(propertyName, callback)
{
    ...
    arguments[1] = propertyName;
    arguments[2] = callback;
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataTableProxy','onDataTablePropertyChanged'], arguments);
};
...
spotfire.webPlayer.Data.DataColumn.prototype.getDataColumnProperties = function(callback)
{
    ...
    arguments[2] = callback;
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataColumnProxy','getDataColumnProperties'], arguments);
};
...
spotfire.webPlayer.Data.DataColumn.prototype.getDataColumnProperty = function(propertyName, callback)
{
    ...
    arguments[3] = callback;
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataColumnProxy','getDataColumnProperty'], arguments);
};
...
spotfire.webPlayer.Data.DataColumn.prototype.setDataColumnProperty = function(propertyName, propertyValue)
{
    ...
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataColumnProxy','setDataColumnProperty'], arguments);
};
...
spotfire.webPlayer.Data.DataColumn.prototype.onDataColumnPropertyChanged = function(propertyName, callback)
{
    ...
    arguments[2] = propertyName;
    arguments[3] = callback;
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataColumnProxy','onDataColumnPropertyChanged'], arguments);
};
spotfire.webPlayer.Data.DataColumn.prototype.getDistinctValues = function (startIndex, responseLimit, callback) {
    ...
    arguments[0] = this.dataTableName;
    arguments[1] = this.dataColumnName;
    arguments[2] = startIndex;
    arguments[3] = responseLimit;
    arguments[4] = callback;
    this._document._executeApiMethod(['webPlayerProxy','analysisDocumentProxy','dataColumnProxy','getDataColumnDistinctValues'], arguments);
};
...
spotfire.webPlayer.Document.prototype._loadProxyAndExecute = function (spawnView, onReadyCallback)
{
    ...
    var src = app._webPlayerServerRootUrl + "OpenProxy.aspx";
